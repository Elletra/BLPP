...
namespace TorqueLinter
{
	static public class Constants
	{
		static public class Parser
		{
			...
			public const string ADD_TOKEN = "+";
			public const string SUB_TOKEN = "-";
			public const string MUL_TOKEN = "*";
			public const string DIV_TOKEN = "/";
			public const string LT_TOKEN = "<";
			public const string GT_TOKEN = ">";
			public const string LOGIC_NOT_TOKEN = "!";
			public const string ASSIGN_TOKEN = "=";
			public const string MOD_TOKEN = "%";
			public const string BIT_OR_TOKEN = "|";
			public const string BIT_AND_TOKEN = "&";
			public const string BIT_XOR_TOKEN = "^";
			public const string BIT_NOT_TOKEN = "~";
			...
			public const string BIT_XOR_ASSIGN_TOKEN = "^=";
